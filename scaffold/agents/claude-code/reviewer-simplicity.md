...
description: Review implementation for unnecessary complexity, over-abstraction, speculative features, and AI-generated code patterns that add maintenance burden
model: sonnet
tools:
  - Read
  - Glob
