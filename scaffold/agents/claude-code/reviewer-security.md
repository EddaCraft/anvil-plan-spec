...
description: Review implementation for common vulnerabilities including injection, auth bypass, exposed secrets, missing input validation, and OWASP Top 10 risks
model: sonnet
tools:
  - Read
  - Glob
