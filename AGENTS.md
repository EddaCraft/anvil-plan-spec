...
- AI prompting guides
- Worked examples
- Scaffold tooling for project initialization
...
- **Run markdownlint** before committing (`npm run lint`)

## Execution layer

- **Work items** define outcomes (what to achieve)
- **Action plans** define actions (what to do, not how)
